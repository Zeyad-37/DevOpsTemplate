...
import com.zeyad.rxredux.Result.Companion.loadingResult
import com.zeyad.rxredux.Result.Companion.successResult
import com.zeyad.rxredux.UIModel.Companion.IDLE
import com.zeyad.rxredux.UIModel.Companion.errorState
import com.zeyad.rxredux.UIModel.Companion.loadingState
import com.zeyad.rxredux.UIModel.Companion.successState
...
abstract class BaseViewModel<S : Parcelable>(private val eventsSubject: PublishSubject<BaseEvent> =
    ...
    abstract fun mapEventsToActions(): io.reactivex.functions.Function<BaseEvent, Flowable<Any>>
